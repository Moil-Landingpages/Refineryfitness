...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Refinery Fitness of Buda | Train with more in mind", description: "Faith-first, science-backed coaching for people who are done starting over.", type: "website", locale: "en_US", url: "/", images: [{ url: "/og.png", width: 1200, height: 630, alt: "Train with more in mind — Refinery Fitness of Buda" }] },
  twitter: { card: "summary_large_image", title: "Refinery Fitness of Buda", description: "Train with more in mind.", images: ["/og.png"] },
